...
public:
  ...
  TVector3 GetIntPosition(int i)      const { return GetInteractionPoint(i).GetPosition(GetCrystalId()); } //original pcb
  //TVector3 GetIntPosition(unsigned int i)   const;  // position of the ith segment, Global coor. from pjf
